...
get_filename_component(_filename "/home/afif/catkin_ws/src/myworkcell_core/srv/LocalizePart.srv" NAME_WE)
add_custom_target(_myworkcell_core_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "myworkcell_core" "/home/afif/catkin_ws/src/myworkcell_core/srv/LocalizePart.srv" "geometry_msgs/Pose:geometry_msgs/Quaternion:geometry_msgs/Point"
)
...
_generate_srv_cpp(myworkcell_core
  "/home/afif/catkin_ws/src/myworkcell_core/srv/LocalizePart.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/myworkcell_core)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/myworkcell_core\")")
  # install generated code
  install(
